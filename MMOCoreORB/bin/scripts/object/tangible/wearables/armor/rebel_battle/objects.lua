...
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_bicep_l_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_bicep_l",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_bicep_l",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_bicep_l",
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_bicep_r = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_bicep_r_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_bicep_r",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_bicep_r",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_bicep_r",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_boots = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_boots_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_boots",

	gameObjectType = 263,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_boots",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_boots",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_bracer_l = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_bracer_l_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_bracer_l",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_bracer_l",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_bracer_l",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_bracer_r = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_bracer_r_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_bracer_r",

	gameObjectType = 261,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_bracer_r",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_bracer_r",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_chest_plate = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_chest_plate_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_chest_plate",

	gameObjectType = 257,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_chest_plate",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_chest_plate",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_gloves = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_gloves_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_gloves",

	gameObjectType = 262,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_gloves",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_gloves",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_helmet = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_helmet_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_helmet",

	gameObjectType = 258,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_helmet",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_helmet",
	onlyVisibleInTools = 0,
...
object_tangible_wearables_armor_rebel_battle_shared_armor_rebel_battle_leggings = SharedTangibleObjectTemplate:new {
	...
	--Data below here is deprecated and loaded from the tres, keeping for easy lookups
--[[
	appearanceFilename = "appearance/armor_rebel_battle_s01_leggings_f.sat",
	...
	detailedDescription = "@wearables_detail:armor_rebel_battle_pants",

	gameObjectType = 260,

	locationReservationRadius = 0,
	lookAtText = "@wearables_lookat:armor_rebel_battle_pants",

	noBuildRadius = 0,

	objectName = "@wearables_name:armor_rebel_battle_pants",
	onlyVisibleInTools = 0,
